...
CREATE TABLE Answers (idAnswer int IDENTITY(1, 1) NOT NULL, [date] datetime DEFAULT GETDATE() NOT NULL, FK_option int NOT NULL, FK_client int NOT NULL, PRIMARY KEY (idAnswer));
...
CREATE TABLE ClientTypes (idClientType int IDENTITY(1, 1) NOT NULL, name varchar(50) NOT NULL, hasProducts bit NOT NULL, PRIMARY KEY (idClientType));
